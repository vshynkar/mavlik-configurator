#ifndef _MENU_HANDLER_NEW_H
#define _MENU_HANDLER_NEW_H
...
const byte menuConfigModemRows[] = {
  3,    // Модем->Память
  4,    // Модем->Екран
  5,    // Память->Модем
  6     // Память->Екран
...
const byte menuConfigSlotsRows[] = {
  13,    // Видалити усі
  14     // Видалити один
};
...
class MenuHandlerNew {
  public:
    MenuHandlerNew(Adafruit_PCD8544* d, ScreenHandler* scr, I2C_eeprom* e);
